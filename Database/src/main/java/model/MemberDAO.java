...
//		}
	...
	// 데이터 베이스에 한사람의 회원 정보를 저장해쥬는 메소드
	...
	public Vector<MemberBean> allSelectMember() {
		...
		try {
			...
			// 쿼리를 실행시킨 결과를 리턴해서 받아줌 (오라클 테이블에 검색된 결과를 자바객체에 저장)
			rs = pstmt.executeQuery();

			// 반복문을 사용해서 rs에 저장된 데이터를 추출해놓아여함
